...
export const styles = StyleSheet.create({
  ...
  card1: {
    backgroundColor: CORES_CATEGORIA.destaque.bg,
  ...
  card2: {
    backgroundColor: CORES_CATEGORIA.categorias.bg,
    borderRadius: MEDIDAS.radiusM,
    padding: 24,
    flex: 1,
    minWidth: 250,
  ...
  card3: {
    backgroundColor: CORES_CATEGORIA.recomendados.bg,
    borderRadius: MEDIDAS.radiusM,
    padding: 24,
    flex: 1,
    minWidth: 250,
  ...
  txt1: {
    fontFamily: FONTES.titulo.bold,
    fontSize: 24,
    color: CORES_CATEGORIA.destaque.texto,
    textAlign: 'right',
  },
  ...
  txt2: {
    fontFamily: FONTES.titulo.bold,
    fontSize: 24,
    color: CORES_CATEGORIA.categorias.texto,
    textAlign: 'right',
  },
  ...
  txt3: {
    fontFamily: FONTES.titulo.bold,
    fontSize: 24,
    color: CORES_CATEGORIA.recomendados.texto,
    textAlign: 'right',
  },
})